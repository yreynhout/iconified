...
pub fn cpu_chip_icon(
  ...
  svg.svg(
    ...
    [
      svg.path([attribute.attribute("d", "M16.5 7.5h-9v9h9v-9Z")]),
      svg.path([
        attribute.attribute("clip-rule", "evenodd"),
        attribute.attribute(
          "d",
  ...
  svg.svg(
    ...
    [
      svg.path([
        attribute.attribute(
          "d",
          "M10.5 18a.75.75 0 0 0 0 1.5h3a.75.75 0 0 0 0-1.5h-3Z",
        ),
      ]),
      svg.path([
        attribute.attribute("clip-rule", "evenodd"),
  ...
  svg.svg(
    ...
    [
      svg.path([
        attribute.attribute(
          "d",
          "M11.625 16.5a1.875 1.875 0 1 0 0-3.75 1.875 1.875 0 0 0 0 3.75Z",
        ),
      ]),
      svg.path([
        attribute.attribute("clip-rule", "evenodd"),
...
pub fn eye_icon(attributes: List(attribute.Attribute(a))) -> element.Element(a) {
  svg.svg(
    ...
    [
      svg.path([attribute.attribute("d", "M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z")]),
      svg.path([
        attribute.attribute("clip-rule", "evenodd"),
        attribute.attribute(
          "d",
...
pub fn tv_icon(attributes: List(attribute.Attribute(a))) -> element.Element(a) {
  svg.svg(
    ...
    [
      svg.path([attribute.attribute("d", "M19.5 6h-15v9h15V6Z")]),
      svg.path([
        attribute.attribute("clip-rule", "evenodd"),
        attribute.attribute(
          "d",
