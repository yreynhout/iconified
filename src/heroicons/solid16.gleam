  ...
  svg.svg(
    ...
    [
      svg.path([
        attribute.attribute(
          "d",
          "M9.5 8.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z",
        ),
      ]),
      svg.path([
        attribute.attribute("clip-rule", "evenodd"),
...
pub fn cpu_chip_icon(
  ...
  svg.svg(
    ...
    [
      svg.path([attribute.attribute("d", "M6 6v4h4V6H6Z")]),
      svg.path([
        attribute.attribute("clip-rule", "evenodd"),
        attribute.attribute(
          "d",
...
pub fn document_magnifying_glass_icon(
  ...
  svg.svg(
    ...
    [
      svg.path([
        attribute.attribute("d", "M6 7.5a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0Z"),
      ]),
      svg.path([
        attribute.attribute("clip-rule", "evenodd"),
        attribute.attribute(
...
pub fn eye_icon(attributes: List(attribute.Attribute(a))) -> element.Element(a) {
  svg.svg(
    ...
    [
      svg.path([
        attribute.attribute("d", "M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"),
      ]),
      svg.path([
        attribute.attribute("clip-rule", "evenodd"),
        attribute.attribute(
  ...
  svg.svg(
    ...
    [
      svg.path([
        attribute.attribute(
          "d",
          "M8 1a2 2 0 0 0-2 2v4a2 2 0 1 0 4 0V3a2 2 0 0 0-2-2Z",
        ),
      ]),
      svg.path([
        attribute.attribute(
  ...
  svg.svg(
    ...
    [
      ...
      svg.path([
        attribute.attribute(
          "d",
          "M13 5h-1.5v6.25a1.25 1.25 0 1 0 2.5 0V6a1 1 0 0 0-1-1Z",
        ),
      ]),
    ],
  )
...
pub fn qr_code_icon(
  ...
  svg.svg(
    ...
    [
      svg.path([
        attribute.attribute("d", "M4.75 4.25a.5.5 0 1 0 0 1 .5.5 0 0 0 0-1Z"),
      ]),
      svg.path([
        attribute.attribute("clip-rule", "evenodd"),
        attribute.attribute(
      ...
      svg.path([
        attribute.attribute("d", "M4.25 11.25a.5.5 0 1 1 1 0 .5.5 0 0 1-1 0Z"),
      ]),
      svg.path([
        attribute.attribute("clip-rule", "evenodd"),
        attribute.attribute(
      ...
      svg.path([
        attribute.attribute("d", "M11.25 4.25a.5.5 0 1 0 0 1 .5.5 0 0 0 0-1Z"),
      ]),
      svg.path([
        attribute.attribute("clip-rule", "evenodd"),
        attribute.attribute(
...
pub fn signal_icon(
  ...
  svg.svg(
    ...
    [
      svg.path([attribute.attribute("d", "M9 8a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z")]),
      svg.path([
        attribute.attribute("clip-rule", "evenodd"),
        attribute.attribute(
          "d",
...
pub fn truck_icon(
  ...
  svg.svg(
    ...
    [
      ...
      svg.path([attribute.attribute("d", "M6 13a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z")]),
    ],
  )
}
...
pub fn tv_icon(attributes: List(attribute.Attribute(a))) -> element.Element(a) {
  svg.svg(
    ...
    [
      svg.path([attribute.attribute("d", "M12 5H4v4h8V5Z")]),
      svg.path([
        attribute.attribute("clip-rule", "evenodd"),
        attribute.attribute(
          "d",
