...
pub fn main() -> Nil {
  case argv.load().arguments {
    ["heroicons", icon_directory_path, generated_code_file_path] -> {
...
fn is_element_with_children(name: String) -> Bool {
  let elements_with_children = set.from_list([
    "a",
    "defs",
    "g",
    "marker",
...
fn to_lustre_function_name(name: String) -> String {
  let element_name_map = dict.from_list([
    #("a", "a"),
    #("animate", "animate"),
